    ...
    public function run()
    {
        ...
        $products = [
            ...
            [
                ...
                'bathrooms' => 6,
                'area' => 450,
                'features' => 'مسبح، حديقة، موقف سيارات، غرفة خادمة',
                'category' => 'فيلا',
                'image' => 'products/villa1.jpg',
                'images' => 'products/villa1_1.jpg,products/villa1_2.jpg,products/villa1_3.jpg',
            ...
            [
                ...
                'bathrooms' => 3,
                'area' => 180,
                'features' => 'مصعد، موقف سيارات، نظام أمن، مطبخ مجهز',
                'category' => 'شقة',
                'image' => 'products/apartment1.jpg',
                'images' => 'products/apartment1_1.jpg,products/apartment1_2.jpg,products/apartment1_3.jpg',
            ...
            [
                ...
                'bathrooms' => 3,
                'area' => 250,
                'features' => 'حديقة خاصة، مدخل سيارة، غرفة سائق',
                'category' => 'دور',
                'image' => 'products/floor1.jpg',
                'images' => 'products/floor1_1.jpg,products/floor1_2.jpg,products/floor1_3.jpg',
            ...
            [
                ...
                'bathrooms' => 24,
                'area' => 800,
                'features' => 'مصاعد، مواقف سيارات، نظام مراقبة، خزان مياه',
                'category' => 'عمارة',
                'image' => 'products/building1.jpg',
                'images' => 'products/building1_1.jpg,products/building1_2.jpg,products/building1_3.jpg',
            ...
            [
                ...
                'bathrooms' => 7,
                'area' => 550,
                'features' => 'مسبح، حديقة، غرفة سائق، غرفة خادمة، مصعد داخلي، نظام ذكي',
                'category' => 'فيلا',
                'image' => 'products/villa2.jpg',
                'images' => 'products/villa2_1.jpg,products/villa2_2.jpg,products/villa2_3.jpg',
            ...
            [
                ...
                'price' => 8500000.00,
                'area' => 2000,
                'features' => 'مواقف سيارات، مصاعد، نظام أمن متكامل، تكييف مركزي',
                'category' => 'تجاري',
                'image' => 'products/commercial1.jpg',
                'images' => 'products/commercial1_1.jpg,products/commercial1_2.jpg,products/commercial1_3.jpg',
            ...
            [
                ...
                'bathrooms' => 2,
                'area' => 140,
                'features' => 'مفروشة بالكامل، مكيفات، مطبخ مجهز، انترنت',
                'category' => 'شقة',
                'image' => 'products/apartment2.jpg',
                'images' => 'products/apartment2_1.jpg,products/apartment2_2.jpg,products/apartment2_3.jpg',
            ...
            [
                ...
                'area' => 200,
                'features' => 'تكييف مركزي، مواقف خاصة، أمن 24 ساعة، قاعة اجتماعات مشتركة',
                'category' => 'مكتب',
                'image' => 'products/office1.jpg',
                'images' => 'products/office1_1.jpg,products/office1_2.jpg,products/office1_3.jpg',
                'monthly_installment' => null,
                'ad_number' => 'AD008',
                'property_usage' => 'تجاري',
                'property_facade' => 'شمالي',
            ...
            [
                ...
                'bathrooms' => 5,
                'area' => 1000,
                'features' => 'مسبح، ملعب كرة قدم، جلسات خارجية، مطبخ مجهز، غرف نوم',
                'category' => 'استراحة',
                'image' => 'products/chalet1.jpg',
                'images' => 'products/chalet1_1.jpg,products/chalet1_2.jpg,products/chalet1_3.jpg',
                'monthly_installment' => null,
                'ad_number' => 'AD009',
                'property_usage' => 'سكني',
                'property_facade' => 'شمالي',
            ...
            [
                ...
                'bathrooms' => 120,
                'area' => 5000,
                'features' => 'مصاعد، مواقف سيارات، نظام أمن، مسبح، نادي رياضي، حضانة أطفال',
                'category' => 'برج',
                'image' => 'products/tower1.jpg',
                'images' => 'products/tower1_1.jpg,products/tower1_2.jpg,products/tower1_3.jpg',
            ...
            [
                ...
                'bathrooms' => 6,
                'area' => 400,
                'features' => 'مفروش بالكامل، مسبح خاص، حديقة، غرفة خادمة، غرفة سائق، مصعد',
                'category' => 'فيلا',
                'image' => 'products/villa3.jpg',
                'images' => 'products/villa3_1.jpg,products/villa3_2.jpg,products/villa3_3.jpg',
                'monthly_installment' => null,
                'ad_number' => 'AD011',
                'property_usage' => 'سكني',
                'property_facade' => 'شمالي',
            ...
            [
                ...
                'area' => 3000,
                'features' => 'مواقف سيارات، مصاعد، نظام أمن، تكييف مركزي، خدمات صيانة',
                'category' => 'تجاري',
                'image' => 'products/mall1.jpg',
                'images' => 'products/mall1_1.jpg,products/mall1_2.jpg,products/mall1_3.jpg',
                'monthly_installment' => null,
                'ad_number' => 'AD012',
                'property_usage' => 'تجاري',
                'property_facade' => 'شرقي',
            ...
            [
                ...
                'bathrooms' => 2,
                'area' => 120,
                'features' => 'مفروش بالكامل، خدمات فندقية، مواقف سيارات، صالة رياضية، مسبح',
                'category' => 'شقة',
                'image' => 'products/apartment3.jpg',
                'images' => 'products/apartment3_1.jpg,products/apartment3_2.jpg,products/apartment3_3.jpg',
                'monthly_installment' => null,
                'ad_number' => 'AD013',
                'property_usage' => 'سكني',
                'property_facade' => 'شمالي',
            ...
            [
                ...
                'area' => 1000,
                'features' => 'ارتفاع 8 متر، باب تحميل، مكتب إداري، نظام إطفاء، كاميرات مراقبة',
                'category' => 'مستودع',
                'image' => 'products/warehouse1.jpg',
                'images' => 'products/warehouse1_1.jpg,products/warehouse1_2.jpg,products/warehouse1_3.jpg',
                'monthly_installment' => null,
                'ad_number' => 'AD014',
