        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h2>تعديل قيمة الشركة</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.company-values.update', $value) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i id="iconPreview" class="{{ $value->icon }}"></i></span>
                                <input type="text" 
