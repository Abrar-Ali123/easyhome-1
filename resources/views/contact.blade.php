...
@section('content')
        ...
        <section class="etmam-section tf-section">
            ...
            <div class="feature-grid row m-auto text-right mt-5">
                <div class="feature-item col-6 col-md-4">
                    <div class="features d-flex gap-2 justify-center">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-7">
                    ...
                    <div class="wrap-info">
                        <div class="box-info flex align-center">
                            ...
                            <div class="content">
                                <h5 class="text-color-4">عنوان المكتب</h5>
                                <h4 class="fw-4 text-color-">إيزي هوم العقارية، 7373 فرعي حي الصفا، جدة 2555.
                ...
                <div class="col-lg-6 col-md-5">
                    <div class="images z-2 relative">
                        <img src="{{ asset('') }}/images/mark/mark-contact3.png" alt="images">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="flat-map">
        <div class="container-fuild">
            ...
            <iframe class="map-content"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3711.0943039791346!2d39.21892618505869!3d21.543167585721974!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c3d10048d9b21f%3A0x5445350df545b355!2z2LTYsdmD2Kkg2KfZitiy2Yog2YfZiNmFINin2YTYudmC2KfYsdmK2Kk!5e0!3m2!1sar!2seg!4v1734624283129!5m2!1sar!2seg"
    ...
    <section class="flat-contact-page page tf-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div id="comments" class="comments bg-white">
                        <div class="heading-box center">
                            ...
                            <p>لوريم جزر جدا ، مطور الطماطم الجامعية.سريري ولكن الدبابات وميكروويف الأرز
                                لورم الكراهية</p>
                        </div>
                        <div class="respond-comment">
                            <form method="POST" class="comment-form form-submit" action="{{ route('contacts.store') }}">
                                @csrf
                                ...
                                <div class="text-wrap flex form-wg">
                                    ...
                                    <fieldset class="">
                                        ...
                                        <input type="text" class="tb-my-input" name="phone"
                                            placeholder=" رقم الهاتف" required="" value="{{ old('phone') }}">
                                        @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
