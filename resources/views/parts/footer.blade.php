        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-12">
                <div class="group-icon">
                    <div class="box-icons flex">
                        <div class="images">
                            <img src="{{ asset('') }}/images/icon/footer-icon-1.png" alt="images">
                        </div>
                        <div class="content">
                            <div class="title-icon fs-30 lh-45 fw-7 text-color-2">أنت بحاجة إلى منزل</div>
                            <p class="font-2 text-color-2">أخبرنا احتياجاتك ، سنقدم لك الآلاف من الاقتراحات
                                لمنزل الأحلام.</p>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="group-icon group-2">
                    <div class="box-icons flex">
                        <div class="images">
                            <img src="{{ asset('') }}/images/icon/footer-icon-2.png" alt="images">
                        </div>
                        <div class="content">
                            <div class="title-icon fs-30 lh-45 fw-7 text-color-2">بيع منزلك</div>
                            <p class="font-2 text-color-2">سنقوم بتوصيلك بآلاف الأشخاص الذين يحتاجون إلى شراء ملف
                                بيت.</p>
                        </div>
                    </div>
                    <div class="button-footer center">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="widget widget-info">
                    ...
                    <h5 class="text-color-1">إيزي هوم العقارية، 7373 فرعي حي الصفا، جدة 2555</h5>
                    <p class="sub-title">فرع:</p>
                    <p class="text-1 text-color-8">Easyhome Real Estate Agency, 7373 , AlSafa, Jeddah 2555
                    ...
                    <div class="box-icon flex align-center">
                        <div class="icon flex-none">
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.3">
                                    <mask id="mask0_2290_9114" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                        x="6" y="6" width="39" height="38">
                                    ...
                                    <g mask="url(#mask0_2290_9114)">
                                        ...
                                        <path
                                            ...
                                            stroke="white" stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M31.0829 19.7649C31.4424 21.1118 31.2326 22.2836 30.7562 23.4814"
                                            stroke="white" stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M30.366 11.5664L24.9999 7.11327L19.6339 11.5664" stroke="white"
                                            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M12.3828 17.5839L7.11328 21.957V42.8867H42.8868V21.957L37.6173 17.5839"
                                            stroke="white" stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M25 33.0898L37.6173 25.2368V11.5663H12.3828V25.2368L25 33.0898Z"
                                            stroke="white" stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M42.8868 21.957L25.0001 33.0898L7.11328 21.957V42.8867H42.8868V21.957Z"
                                            stroke="white" stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </g>
                                </g>
                        ...
                        <div class="content">
                            <p>بريد إلكتروني:</p>
                            <a href="mailto:easyhome@gmail.com">
                                <h5 class="fw-4 text-color-8">easyhome@gmail.com</h5>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="widget widget-menu widget-form">
                    ...
                    <form method="post" class="comment-form form-submit" action="#" accept-charset="utf-8">
                        <p class="font-2 text-color-8">اشترك لتلقي أحدث المقالات</p>
                        ...
                        <label class="flex">
                            ...
                            <span class="fs-12 text-color-8 lh-18">لقد قرأت وأوافق على الشروط &
                                شروط</span>
                        </label>
                    </form>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="wrap-logo flex align-center justify-space">
                    <div class="logo-footer style box-1" id="">
                        <a href="index.html">
                            <img src="{{ asset('/images/9.png') }}" alt="img" width="50">
                        </a>
                    </div>
...
<div class="widget-bottom-footer">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="title-bottom center"> © 2024 جميع الحقوق محفوظة - إيزي هوم العقارية.
            ...
            <div class="modal-body space-y-20 pd-40">
                <div class="wrap-modal flex">
                    <div class="image flex-none">
                        <img src="{{ asset('') }}/images/section/bg-login.jpg" alt="images">
                    </div>
                    <div class="content">
                        <div class="title-login fs-30 fw-7 lh-45">تسجيل الدخول</div>
                        <div class="comments">
                            <div class="respond-comment">
                                <form class="comment-form form-submit" method="POST" action="{{ route('login') }}">
                                    @csrf
                                    <fieldset class="">
                                        <label class="fw-6">حساب</label>
                                        <input type="email" id="email" class="tb-my-input" name="email"
                                            placeholder="البريد الإلكتروني ">
                                        <img class="img-icon img-email"
                                            src="{{ asset('') }}/images/icon/icon-gmail.svg" alt="images">
                                    </fieldset>
                                    <fieldset class="style-wrap">
                                        <label class="fw-6">كلمة المرور</label>
                                        <input type="password" name="password" class="input-form password-input"
                                            placeholder="كلمة المرور الخاصة بك">
                                        <img class="img-icon" src="{{ asset('') }}/images/icon/icon-password.svg"
                                            alt="images">
                                    </fieldset>
                                    <div class="title-forgot"><a class="fs-13">هل نسيت كلمة السر</a> </div>
                        ...
                        <div class="text-box text-center fs-13">ليس لديك حساب? <a
                                class="font-2 fw-7 fs-13 color-popup text-color-3" data-toggle="modal"
                                data-target="#popup_bid2" data-dismiss="modal" aria-label="Close">تسجيل جديد</a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-body space-y-20 pd-40 style2">
                <div class="wrap-modal flex">
                    <div class="images flex-none relative">
                        <img src="{{ asset('') }}/images/section/bg-register.jpg" alt="images">
                        <div class="mark-logo">
                            <img src="{{ asset('') }}/images/logo/logo2.png" alt="images">
                        </div>
                    </div>
                    <div class="content">
                        <div class="title-login fs-30 fw-7 lh-45">تسجيل جديد</div>
                        <div class="comments">
                            <div class="respond-comment">
                                <form method="POST" class="comment-form form-submit"
                                    ...
                                    <fieldset class="">
                                        <label class="fw-6">اسم المستخدم</label>
                                        <input type="text" class="tb-my-input" name="name"
                                            placeholder="اسم المستخدم">
                                        <img class="img-icon img-name"
                                            src="{{ asset('') }}/images/icon/login-user.svg" alt="images">
                                    </fieldset>
                                    <fieldset class="t">
                                        <label class="fw-6">بريد إلكتروني</label>
                                        <input type="email" class="tb-my-input" name="email"
                                            placeholder="بريد إلكتروني">
                                        <img class="img-icon" src="{{ asset('') }}/images/icon/icon-gmail.svg"
                                            alt="images">
                                    </fieldset>
                                    <fieldset class="">
                                        <label class="fw-6">كلمة المرور</label>
                                    ...
                                    <fieldset class="">
                                        <label class="fw-6">تأكيد كلمة المرور</label>
                                        <input type="password" name="password_confirmation"
                                            class="input-form password-input" placeholder="تأكيد كلمة المرور">
                                        <img class="img-icon" src="{{ asset('') }}/images/icon/icon-password.svg"
                                            alt="images">
                                    </fieldset>
                                    <button class="sc-button" name="submit" type="submit">
                        ...
                        <div class="text-box text-center fs-13">بالفعل حساب? <a
                                class="font-2 fw-7 fs-13 color-popup text-color-3" data-toggle="modal"
                                data-target="#popup_bid" data-dismiss="modal" aria-label="Close">تسجيل الدخول</a>
                        </div>
                    </div>
                </div>
            </div>
