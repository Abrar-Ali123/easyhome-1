...
<div class="container">
    ...
    <section class="property-main">
        <img src="{{ url('easyhome/storage/app/public/' . $product->image) }}" alt="صورة العقار الرئيسية">
    </section>
...
<div class="feature-item">
                ...
                <div class="feature-item">
                <i class="fas fa-bed"></i> {{ $product->bedrooms }} دوات مياه
                </div>

                <div class="feature-item">
                <i class="fas fa-bed"></i> {{ $product->bedrooms }} المساحة
                </div>
                ...
                <div class="feature-item">
                <i class="fas fa-bed"></i> {{ $product->bedrooms }} الحي
                </div>
