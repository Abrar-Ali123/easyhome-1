                    ...
                    <div class="wrap-house wg-dream flex bg-white">
                        <div class="box-1">
                            ...
                            <div class="inner flex">
                                <div class="sales fs-12 fw-7 font-2 text-color-1">{{ $product->property_usage }}</div>
                ...
                <div class="col-lg-8">
                    <div class="post">
                                        ...
                                        <div class="icon">
                                            <svg width="18" height="16" viewBox="0 0 18 16" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke-linejoin="round" />
                                                <path d="M3.73047 6.22876H14.2707V14.6051H3.73047V6.22876Z" stroke="#8E8E93"
                        ...
                        <div class="wrap-virtual wrap-style">
                            <h3 class="titles">الكروكي</h3>
                            <div class="virtual-box relative flex align-center justify-center">
                                <div class="images">
                                    @if($product->croquis)
                                        <img class="img-2" src="{{ asset('images/croquis/' . $product->croquis) }}" alt="كروكي العقار">
                                    @else
                                        <img class="img-2" src="{{ asset('images/no-croquis.jpg') }}" alt="لا يوجد كروكي">
                                    @endif
                                </div>
                            </div>
                        </div>
