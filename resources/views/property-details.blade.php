            ...
            <div class="col-lg-12">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="image-detail">
                                <img src="{{ asset('') }}/images/slider/slider-detail-1.jpg" alt="images">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="image-detail">
                                <img src="{{ asset('') }}/images/slider/slider-detail-12.jpg" alt="images">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="image-detail">
                                <img src="{{ asset('') }}/images/slider/slider-detail-13.jpg" alt="images">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="image-detail">
                                <img src="{{ asset('') }}/images/slider/slider-detail-14.jpg" alt="images">
                            </div>
                        </div>
                    </div>
                ...
                <div thumbsSlider="" class="swiper-container thumbs-swiper-column1 swiper-pagination5">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="image-detail">
                                <img src="{{ asset('') }}/images/slider/slider-pagi-4.jpg" alt="images">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="image-detail">
                                <img src="{{ asset('') }}/images/slider/slider-pagi-1.jpg" alt="images">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="image-detail">
                                <img src="{{ asset('') }}/images/slider/slider-pagi-2.jpg" alt="images">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="image-detail">
                                <img src="{{ asset('') }}/images/slider/slider-pagi-3.jpg" alt="images">
                            </div>
                        </div>
                ...
                <div class="post">
                        ...
                        <div class="flat-accordion fl-faq-content">
                            <div class="flat-toggle ">
                                ...
                                <div class="toggle-content section-desc">
                                    <img src="{{ asset('') }}/images/img-box/property-5.jpg" alt="">
                    ...
                    <div class="wrap-video wrap-style">
                        ...
                        <div class="video-box center ">
                            <div class="post-video flex align-center justify-center  relative">
                                <img class="img-2" src="{{ asset('') }}/images/img-box/property-video.jpg" alt="images">
                    ...
                    <div class="wrap-virtual wrap-style">
                        ...
                        <div class="virtual-box relative flex align-center justify-center">
                            <div class="images">
                                <img class="img-2" src="{{ asset('') }}/images/img-box/property-6.jpg" alt="images">
                            </div>
                    ...
                    <div class="wrap-review wrap-style">
                        ...
                        <div class="comment-list">
                            <ol class="">
                                ...
                                <li class="flex">
                                    <div class="images flex-none">
                                        <img src="{{ asset('') }}/images/author/author-review-2.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <div class="title-item flex justify-space align-center">
                                            <h4>Jenny Wilson</h4>
                                ...
                                <li class="flex">
                                    <div class="images flex-none">
                                        <img src="{{ asset('') }}/images/author/author-review-3.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <div class="title-item flex justify-space align-center">
                                            <h4>Bessie Cooper</h4>
                        ...
                        <div class="widget widget-listings style">
                            ...
                            <div class="box-listings flex hover-img3">
                                <div class="img-listings img-style3">
                                    <img src="{{ asset('') }}/images/img-box/sidebar-listings-1.jpg" alt="images">
                                </div>
                            ...
                            <div class="box-listings flex hover-img3">
                                <div class="img-listings img-style3">
                                    <img src="{{ asset('') }}/images/img-box/sidebar-listings-2.jpg" alt="images">
                                </div>
                                <div class="content link-style-1">
                                    <a class="fs-16 lh-24" href="property-detail-v1.html">Gorgeous Apartment Building</a>
                                    <h4>$7,500</h4>
                            ...
                            <div class="box-listings flex hover-img3">
                                <div class="img-listings img-style3">
                                    <img src="{{ asset('') }}/images/img-box/sidebar-listings-3.jpg" alt="images">
                                </div>
                                <div class="content link-style-1">
                                    <a class="fs-16 lh-24" href="property-detail-v1.html">Gorgeous Apartment Building</a>
                                    <h4>$7,500</h4>
                            ...
                            <ul class="group-estate flex">
                                <li class="box-estate hover-img2">
                                    <div class="thumb img-style2 ">
                                        <img class="img2" src="{{ asset('') }}/images/img-box/sidebar-estate-1.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                ...
                                <li class="box-estate hover-img2">
                                    <div class="thumb img-style2 ">
                                        <img class="img2" src="{{ asset('') }}/images/img-box/sidebar-estate-2.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                ...
                                <li class="box-estate hover-img2">
                                    <div class="thumb img-style2 ">
                                        <img class="img2" src="{{ asset('') }}/images/img-box/sidebar-estate-3.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                ...
                                <li class="box-estate hover-img2">
                                    <div class="thumb img-style2 ">
                                        <img class="img2" src="{{ asset('') }}/images/img-box/sidebar-estate-4.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                ...
                                <li class="box-estate hover-img2">
                                    <div class="thumb img-style2 ">
                                        <img class="img2" src="{{ asset('') }}/images/img-box/sidebar-estate-5.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                ...
                                <li class="box-estate hover-img2">
                                    <div class="thumb img-style2 ">
                                        <img class="img2" src="{{ asset('') }}/images/img-box/sidebar-estate-6.jpg" alt="images">
                                    </div>
                                    <div class="content">
