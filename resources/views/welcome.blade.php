            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <div class="testimonial4_slide">
                        <img class="img-item" src="{{ asset('/images/img/IMG-20241201-WA0037.jpg') }}" alt="رأي العميل 1">
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="testimonial4_slide">
                        <img class="img-item" src="{{ asset('/images/img/IMG-20241201-WA0038.jpg') }}" alt="رأي العميل 2">
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="testimonial4_slide">
                        <img class="img-item" src="{{ asset('/images/img/IMG-20241201-WA0039.jpg') }}" alt="رأي العميل 3">
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="testimonial4_slide">
                        <img class="img-item" src="{{ asset('/images/img/IMG-20241201-WA0040.jpg') }}" alt="رأي العميل 4">
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="testimonial4_slide">
                        <img class="img-item" src="{{ asset('/images/img/IMG-20241201-WA0041.jpg') }}" alt="رأي العميل 5">
                    </div>
                </div>
            </div>
